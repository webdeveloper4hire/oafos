...
<div class="page-header no-margin no-padding">
  ...
  <div class='container'>
    ...
    <div class="no-margin no-padding">
      <img src="img/header10.png" class="img-responsive">
  </div>
  <br>
...
<input class='submit' type="text" name="tb1_colunm17" value=""  placeholder="Island"/>
         ...
         Type of tree:
            ...
            <br />
            Reason for cutting:
                  <input class='form-control' type="text" name="tb1_colunm19" value="">
            Others: 
                  <input class='form-control' type="text" name="tb1_colunm20" value=""></font>
