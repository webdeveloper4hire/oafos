...
<h3>Cutting/Transport Non-Wood Forest Products within Private Land</h3>

     <font style="font:Verdana, Geneva, sans-serif">
Fullname:<u><?php echo $row_rstable1['tb1_colunm6']; ?>,<?php echo $row_rstable1['tb1_colunm7']; ?>,<?php echo $row_rstable1['tb1_colunm8']; ?></u></font>
<br />
 <font style="font:Verdana, Geneva, sans-serif">Date:<u><?php echo $row_rstable1['tb1_colunm10']; ?></u></font>
 <br />

 <font style="font:Verdana, Geneva, sans-serif">Address:<u><?php echo $row_rstable1['tb1_colunm11']; ?>, <?php echo $row_rstable1['tb1_colunm12']; ?>, <?php echo $row_rstable1['tb1_colunm13']; ?>, <?php echo $row_rstable1['tb1_colunm14']; ?>, <?php echo $row_rstable1['tb1_colunm15']; ?>, <?php echo $row_rstable1['tb1_colunm16']; ?></u></font>
 <br />
  <font style="font:Verdana, Geneva, sans-serif">Cutting/Transport Non-Wood Forest Products within Private Land:<u><?php echo $row_rstable1['tb1_colunm18']; ?></u></font>
<br />
<hr />
<p><font style="font:Verdana, Geneva, sans-serif">Please Follow up to the nearest DENR CENRO Office after 5 working day and bring the following requirments.</font>
<ol>
<li>Request letter</li>
<li>Photocopy of tax Declaration or land title</li>
<li>Certification from the Barangay Captain</li>
<ol>
