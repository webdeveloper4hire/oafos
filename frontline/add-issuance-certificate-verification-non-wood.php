...
<div class="page-header no-margin no-padding">
  ...
  <div class='container'>
    ...
    <div class="no-margin no-padding">
      <img src="img/header7.png" class="img-responsive">
  </div>
   <br>
...
<br>
Date:
<input class='submit' type="date" name="tb1_colunm10" value="">
<br>
Address: 
...
<input class='submit' type="text" name="tb1_colunm17" value=""  placeholder="Island"/>
                  <br>
Cutting/Transport Non-Wood Forest Prodeucts within Private Land:
<textarea class='form-control' name="tb1_colunm18" rows="5"></textarea>
</font>
                  <!--
            </div>
