...
<div class="page-header no-margin no-padding">
  ...
  <div class='container'>
    ...
    <div class="no-margin no-padding">
      <img src="img/header12.png" class="img-responsive">
  </div>
   <br>
      ...
      <div class='panel-body'>
       ...
       <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class='form-horizontal' role='form'>
          ...
          <div class='form-group' style="display: none;">
            ...
            <font style="font:Verdana, Geneva, sans-serif" size="4"><br />
Full Name: 
                  ...
                  <input class='submit' type="text" name="tb1_colunm8" value="" placeholder="Middle Name" required><br>

         Date: 
            
                  <input class='submit' type="date" name="tb1_colunm10" value=""><br>
            ...
            Address: 
                  ...
                  <input class='submit' type="text" name="tb1_colunm14" value="" placeholder="Bario/Brgy" required>
                  
                  <input class='submit' type="text" name="tb1_colunm15" value="" placeholder="Municipality" required>
                  
                  <input class='submit' type="text" name="tb1_colunm16" value="" placeholder="Province" required>
                  
                  <input class='submit' type="text" name="tb1_colunm17" value="" placeholder="Island"></font>
         <!--
            <div class='form-group'>
            <label class='control-label col-md-2 col-md-offset-2'>Tb1_colunm18</label>
            <div class='col-md-6'>
                  <input class='form-control' type="text" name="tb1_colunm18" value=""></div>
            </div>
            <div class='form-group'>
            <label class='control-label col-md-2 col-md-offset-2'>Tb1_colunm19</label>
            <div class='col-md-6'>
                  <input class='form-control' type="text" name="tb1_colunm19" value=""></div>
            </div>
            <div class='form-group'>
            <label class='control-label col-md-2 col-md-offset-2'>Tb1_colunm20</label>
            <div class='col-md-6'>
                  <input class='form-control' type="text" name="tb1_colunm20" value=""></div>
            </div>
            <div class='form-group'>
