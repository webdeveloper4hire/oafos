...
<div class="page-header no-margin no-padding">
  ...
  <p><font style="font:Verdana, Geneva, sans-serif" size="4">
Full Name:
...
Date:
<input class='submit' type="date" name="tb1_colunm10" value=""></font>
<br>
Address: 
...
Apply for Appeal
	<select name="tb1_colunm18" required>
        <option value="No-Record">No Record</option>
        <option value="Appeal">Appeal</option>
        <option value="Motion-for-Reconsideration">Motion for Reconsideration</option>
       </select>
