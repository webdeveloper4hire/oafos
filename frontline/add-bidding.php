...
<div class="page-header no-margin no-padding">
  ...
  <div class='container'>
    ...
    <div class="no-margin no-padding">
      <img src="img/header13.png" class="img-responsive">
  </div>
   <br>
...
Full Name: 
                  ...
                  <input class='submit' type="text" name="tb1_colunm8" value="" placeholder="Middle" required>
                  <br>
Date:
...
Type of Biding Document
                           <input class='form-control' type="text" name="tb1_colunm18" value="">
                   Details:       
                  <textarea name="tb1_colunm19"></textarea></font>
          <!--  
