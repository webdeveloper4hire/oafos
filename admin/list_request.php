...
$query_rstable1 = "SELECT * FROM table1 WHERE tb1_colunm1 = 'eservices'";
...
$totalPages_rstable1 = ceil($totalRows_rstable1/$maxRows_rstable1)-1;$maxRows_rstable1 = 10;
$pageNum_rstable1 = 0;
if (isset($_GET['pageNum_rstable1'])) {
  $pageNum_rstable1 = $_GET['pageNum_rstable1'];
}
...
mysql_select_db($database_connection, $connection);
$query_rstable1 = "SELECT * FROM table1 WHERE tb1_colunm1 = 'eservices' ORDER BY table1_id DESC";
$query_limit_rstable1 = sprintf("%s LIMIT %d, %d", $query_rstable1, $startRow_rstable1, $maxRows_rstable1);
$rstable1 = mysql_query($query_limit_rstable1, $connection) or die(mysql_error());
$row_rstable1 = mysql_fetch_assoc($rstable1);
...
<?php require_once('menu.php'); ?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1> List of Request <small>DENR MIMAROPA</small> </h1>
      <ol class="breadcrumb">
...
?></td>
                      ...
                      <td><?php echo $row_rstable1['tb1_colunm11']; ?> <?php echo $row_rstable1['tb1_colunm12']; ?> <?php echo $row_rstable1['tb1_colunm13']; ?> <?php echo $row_rstable1['tb1_colunm14']; ?> <?php echo $row_rstable1['tb1_colunm15']; ?> <?php echo $row_rstable1['tb1_colunm16']; ?> <?php echo $row_rstable1['tb1_colunm17']; ?></td>
