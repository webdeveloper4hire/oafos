...
Full Name: <u><?php echo $row_rstable1['tb1_colunm6']; ?>, <?php echo $row_rstable1['tb1_colunm7']; ?>, <?php echo $row_rstable1['tb1_colunm8']; ?></u><br />
Date: <u><?php echo $row_rstable1['tb1_colunm10']; ?></u><br />
...
Type of Biding Document: <u><?php echo $row_rstable1['tb1_colunm18']; ?></u><br />
Details: <u><?php echo $row_rstable1['tb1_colunm19']; ?></u></font>
<hr />

<p>Please Follow up to the nearest DENR CENRO/PENR Office after 5 working days and bring the following requirments.</p>
<ol>
<li>Printed copy of this Request Form</li>
<li>Invitation to Bid  (for Goods and infrastructure Projects)</li>
<li>Request for Expression of Interest/ Notice of Eligibility and Shortlisting (for Consulting services)</li>
</ol>
</td>
</tr>
</table>
